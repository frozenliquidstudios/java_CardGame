...
public class CardValue implements Comparable {
    ...
    private String symbol;  // acronym of value
//  private static boolean aceIsHighest = true;
//  private static boolean twoIsHighest = true;
    
    private CardValue( String value_name, String value_symbol ) {
      name = value_name;
      symbol = value_symbol;
   }
    ...
    public final static java.util.List VALUES =
      Collections.unmodifiableList( Arrays.asList( new CardValue[] { ACE, TWO, THREE, FOUR, FIVE, SIX, SEVEN,
